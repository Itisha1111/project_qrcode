...
def generateCode():
  ...
  messagebox.showinfo("Ishita's QR Code Generator","QR Code is saved successfully!")

#to create main window with title, size and color
wn = Tk()
wn.title('Ishita\'s QR Code Generator')
wn.geometry('700x700')
...
headingLabel = Label(headingFrame, text="Generate QR Code with Ishita", bg='azure', font=('Times',20,'bold'))
